 ...
 */
public class EntryPointConstants {
	...
	public static final String ACTIVITY_ONRESUMEFRAGMENTS = "void onResumeFragments()";
	...
	public static final String FRAGMENT_ONACTIVITYRESULT = "void onActivityResult(int,int,android.content.Intent)";
	...
	private static final String[] activityMethods = { ACTIVITY_ONCREATE, ACTIVITY_ONSTART,
			ACTIVITY_ONRESTOREINSTANCESTATE, ACTIVITY_ONPOSTCREATE, ACTIVITY_ONRESUME,ACTIVITY_ONRESUMEFRAGMENTS, ACTIVITY_ONPOSTRESUME,
			ACTIVITY_ONCREATEDESCRIPTION, ACTIVITY_ONSAVEINSTANCESTATE, ACTIVITY_ONPAUSE, ACTIVITY_ONSTOP,
			ACTIVITY_ONRESTART, ACTIVITY_ONDESTROY, ACTIVITY_ONATTACHFRAGMENT ,ACTIVITY_ONACTIVITYRESULT};
	private static final List<String> activityMethodList = generateMethod(activityMethods);

	private static final String[] serviceMethods = { SERVICE_ONCREATE, SERVICE_ONSTART1, SERVICE_ONSTART2,
			SERVICE_ONBIND, SERVICE_ONREBIND, SERVICE_ONUNBIND, SERVICE_ONDESTROY };
	private static final List<String> serviceMethodList = generateMethod(serviceMethods);

	private static final String[] fragmentMethods = { FRAGMENT_ONATTACH, FRAGMENT_ONCREATE, FRAGMENT_ONCREATEVIEW,
			FRAGMENT_ONVIEWCREATED, FRAGMENT_ONVIEWSTATERESTORED, FRAGMENT_ONACTIVITYCREATED, FRAGMENT_ONSTART,
			FRAGMENT_ONRESUME,FRAGMENT_ONACTIVITYRESULT, FRAGMENT_ONPAUSE, FRAGMENT_ONSAVEINSTANCESTATE, FRAGMENT_ONSTOP, FRAGMENT_ONDESTROYVIEW,
			FRAGMENT_ONDESTROY, FRAGMENT_ONDETACH };
	private static final List<String> fragmentMethodList = generateMethod(fragmentMethods);
	...
	private static final List<String> gcmIntentServiceMethodList = generateMethod(gcmIntentServiceMethods);
	...
	private static final List<String> gcmListenerServiceMethodList = generateMethod(gcmListenerServiceMethods);

	private static final String[] broadcastMethods = { BROADCAST_ONRECEIVE };
	private static final List<String> broadcastMethodList = generateMethod(broadcastMethods);
	...
	private static final List<String> contentProviderMethodList = generateMethod(contentproviderMethods);

	private static final String[] applicationMethods = { APPLICATION_ONCREATE, APPLICATION_ONTERMINATE };
	private static final List<String> applicationMethodList = generateMethod(applicationMethods);
	...
	private static final List<String> activityLifecycleMethodList = generateMethod(activityLifecycleMethods);
	...
	private static final List<String> componentCallbackMethodList = generateMethod(componentCallbackMethods);

	public static final String[] componentCallback2Methods = { COMPONENTCALLBACKS2_ONTRIMMEMORY };
	public static final List<String> componentCallback2MethodList = generateMethod(componentCallback2Methods);
	...
	private static final List<String> serviceConnectionMethodList = generateMethod(serviceConnectionMethods);
	/*
	 * ========================================================================
	 */
	...
	private static List<String> generateMethod(String[] list) {
